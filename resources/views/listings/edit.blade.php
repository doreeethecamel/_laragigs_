<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
                    ...
                    <form method="PUT" action="{{url('/listings/'.$listing->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-6">
                            <label
                        ...
                        <div class="mb-6">
                            ...
                            />
                            <img
                            class="w-48 mr-6 mb-6" src="{{$listing->logo ? asset('storage/' .$listing->logo) : asset('/images/no-image.png')}}"
                            alt=""
                        />
                        </div>
                        @error('logo')
